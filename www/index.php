...
<body class="home-body">
  <div class="navi-container w-container"><img src="images/ATO-LOGO-ATO-CSSI.png" loading="lazy" width="50" height="50" alt="" class="image">
    ...
    <a href="preneed.html" class="preneed-btn">Preneed</a>
    ...
    <a href="index.php" aria-current="page" class="home-button w--current">Home</a>
  </div>
  <div data-collapse="medium" data-animation="default" data-duration="500" data-easing="ease-in-out" data-easing2="ease-in-out" data-doc-height="1" role="banner" class="mobile-nav w-nav">
    <div class="mobile-nav-menu-container w-container">
      <nav role="navigation" class="mobile-nav-menu w-nav-menu">
        <a href="index.php" aria-current="page" class="home-mobile-link2 w--current">Home</a>
        ...
        <a href="preneed.html" class="preneed-mobile-link w-nav-link">Preneed</a>
  ...
  <div class="home-main-cntr">
    <div class="index-item-0 w-richtext">
      ...
      <p><strong>Alpha to Omega CSSI</strong> wants to help you prepare for an event that we all must face some time in the future by offering preneed funeral arrangement packages suited to every budget.</p>
      ...
      <p>To learn more about our <strong>Programs</strong> and <strong>Services</strong>, please fill out a contact form below and a <strong>Preneed Agents</strong> will contact you to further explain the benefits of our services</p>
    </div>
    ...
    <div id="index-item-main" class="index-item-main w-row">
      ...
      <div class="w-col w-col-6 w-col-stack">
        ...
        <blockquote class="block-quote-2">Spotlight Your Church on Local Atlanta TV As part of the show, Omega Broadcasting Network will give Atlanta a unique behind the scenes look at your church including:<br><br>Highlighting your church facility and its history <br><br>Highlighting your church facility and its history <br>Spotlighting ministries and special programs <br><br>Sharing archival footage from past services, sermons, and choir performances <br><br>Thirty-minute TV air time at no cost to the</blockquote>
